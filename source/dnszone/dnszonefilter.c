...
#define FATAL "dnszonefilter: fatal: "
#define REJECT "#dnszonefilter: line rejected: "


static void die_usage(void) {
    die_1(100, "dnszonefilter: usage: dnszonefilter zone <input >output\n");
}
...
void out(char *buf, long long len) {
